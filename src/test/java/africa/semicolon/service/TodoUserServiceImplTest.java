...
//
//
//import static africa.semicolon.data.model.MyStatus.*;
...
//    private TodoTaskRequest todolistRequest;
//    private EditTodolistRequest editTodolistRequest;
//    private DeleteListRequest deleteTodolistRequest;
...
//
//        todolistRequest = new TodoTaskRequest();
//        todolistRequest.setUsername("username");
//        todolistRequest.setTitle("title");
//        todolistRequest.setAuthor("author");
//        todolistRequest.setBody("body");
//        todolistRequest.setLocalDate(String.valueOf(LocalTime.now()));
//        todolistRequest.setPriority(PENDING);
//
//        editTodolistRequest = new EditTodolistRequest();
//        editTodolistRequest.setAuthor("username");
//        editTodolistRequest.setTaskPriority(PENDING);
//        editTodolistRequest.setTitle("title");
//
//        deleteTodolistRequest = new DeleteListRequest();
//        deleteTodolistRequest.setAuthor("author");
//        deleteTodolistRequest.setTitle("title");
//
//
//        markTaskRequest = new MarkTaskRequest();
//        markTaskRequest.setUsername("username");
//        markTaskRequest.setTitle("title");
//        markTaskRequest.setTaskPriority(SUCCESS);
//
//
//        viewAllPendingTaskRequest = new ViewAllPendingTaskRequest();
//        viewAllPendingTaskRequest.setUsername("username");
//        viewAllPendingTaskRequest.setTaskPriority(PENDING);
//
//
...
//        startTaskRequest.setAuthor("author");
...
//        assignTaskRequest.setTaskPriority(PENDING);
//
//    }
//
//    @Test
